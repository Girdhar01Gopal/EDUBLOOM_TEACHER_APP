...
class MasterDailyActivityViewController extends GetxController {
  ...
  RxList<ProductMasterDashboardItemsModel> dailyActivityList =
  ...
  void dashboardCategory() {
    ...
    dailyActivityList.value = dashboardItems;
  }
}
