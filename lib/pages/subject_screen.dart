        ...
        children: [
          ...
          Align(
            ...
            child: ElevatedButton.icon(
              onPressed: () async {
                // ✅ controller.postSubject() already shows the success/failure
                // snackbar and clears the field on success — no need to repeat it here.
...
class ViewSubjectTab extends GetView<SubjectController> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        // ✅ NEW: Search bar right below the AppBar
        Padding(
        ...
        Expanded(
          child: RefreshIndicator(
            ...
            child: Obx(() {
              ...
              sorted.sort((a, b) => (b.subjectId ?? 0).compareTo(a.subjectId ?? 0));

              // ✅ NEW: apply search filter (subject name, case-insensitive)
              ...
              if (subjects.isEmpty) {
                return const Center(child: Text("🔍 No matching subjects"));
              }
                ...
                itemBuilder: (context, index) {
                  ...
                  return Container(
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: kAxisMaroon.withOpacity(0.15),
                          blurRadius: 10,
                          offset: const Offset(0, 4),
                        ),
                      ],
                      border: Border.all(color: kAxisMaroon.withOpacity(0.2), width: 1.2),
                    ),
                    child: Padding(
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              gradient: LinearGradient(
                                colors: [kAxisMaroon.withOpacity(0.8), kAxisMaroon],
