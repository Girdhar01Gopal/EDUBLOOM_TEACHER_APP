      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          bottom: TabBar(
            ...
            tabs: const [
              Tab(text: "Add Meal Activity"),
              Tab(text: "View Meal Activity"),
            ],
          ),
        ),
        body: TabBarView(
...
// ══════════════════════════════════════
//  ADD MEAL ACTIVITY TAB
// ══════════════════════════════════════
class PostActivity extends GetView<Mealcontroller> {
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 2.h),
                    Text(
                      "Fill details to record student meal",
                      style: TextStyle(
...
// ══════════════════════════════════════
//  VIEW MEAL ACTIVITY TAB
// ══════════════════════════════════════
class ViewActivityScreen extends GetView<Mealcontroller> {
...
void _openStudentSelector(Mealcontroller controller) {
  Get.bottomSheet(
    Container(
...
Widget _submitButton(Mealcontroller controller) {
  return SizedBox(
    width: double.infinity,
    height: 50,
...
Widget _activityField(Mealcontroller controller) {
  return TextFormField(
    controller: controller.activityController,
    maxLines: 3,
    decoration: InputDecoration(
      hintText: "Describe the meal activity...",
