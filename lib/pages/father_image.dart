// ============================================================
// FILE PATH: lib/pages/father_image.dart
// ============================================================
...
class FatherImagePicker extends GetView<StudentController> {
  const FatherImagePicker({super.key});

  Future<void> _pickImage(BuildContext context) async {
    final source = await showModalBottomSheet<ImageSource>(
      context: context,
      backgroundColor: Colors.transparent,
      builder: (_) => _ImageSourceSheet(title: "Father's Photo"),
    );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Father's Photo",
            style: TextStyle(
          ...
          children: [
            ...
            _NextButton(
              ...
              onTap: () => Navigator.push(
                  context, MaterialPageRoute(builder: (_) => MotherImagePicker())),
            ),
            SizedBox(height: 20.h),
          ],
        ),
