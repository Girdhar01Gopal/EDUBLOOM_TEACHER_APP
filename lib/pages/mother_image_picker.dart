// ============================================================
// FILE PATH: lib/pages/mother_image_picker.dart
// ============================================================
...
import 'guardian_image_picker.dart';
...
class MotherImagePicker extends GetView<StudentController> {
  const MotherImagePicker({super.key});

  Future<void> _pickImage(BuildContext context) async {
    final source = await showModalBottomSheet<ImageSource>(
      context: context,
      backgroundColor: Colors.transparent,
      builder: (_) => _ImageSourceSheet(title: "Mother's Photo"),
    );
    if (source == null) return;
    final XFile? picked = await controller.picker.pickImage(source: source);
    if (picked != null) {
      controller.motherPic.value = File(picked.path);
    } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Mother's Photo",
            style: TextStyle(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            _NextButton(
              label: 'Next  →  Guardian Photo',
              onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => GuardianImagePicker())),
            ),
            SizedBox(height: 20.h),
          ],
        ),
