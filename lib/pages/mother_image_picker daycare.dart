// ============================================================
// FILE PATH: lib/pages/mother_image_picker daycare.dart
// ============================================================
...
class MotherImagePickerdaycare extends GetView<StudentControllerdaycare> {
  const MotherImagePickerdaycare({super.key});

  Future<void> _pickImage(BuildContext context) async {
    final source = await showModalBottomSheet<ImageSource>(
      context: context,
      backgroundColor: Colors.transparent,
      builder: (_) => const _ImageSourceSheet(title: "Mother's Photo"),
    );
          ...
          children: [
            ...
            _NextButton(
              ...
              onTap: () => Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => GuardianImagePickerdaycare()),
              ),
            ),
