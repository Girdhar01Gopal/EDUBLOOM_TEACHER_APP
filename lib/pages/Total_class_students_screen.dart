...
import '../infrastructures/utils/local_storage/local_storage.dart'; // ✅ fixed: relative import
import '../infrastructures/utils/local_storage/pref_const.dart';     // ✅ fixed: relative import
...
class _ClassStudentsScreenState extends State<ClassStudentsScreen> {
  List<StudentData> classStudents = [];
  ...
  Future<void> _loadStudents() async {
    ...
    try {
      final url = Uri.parse(
        'https://playschool.edubloom.in/api/StudentApp/GetAllStudentAsynsApp',
      );
            ...
            child: Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Search by name, phone, roll no...',
                  hintStyle: TextStyle(
            ...
            child: isLoading
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) =>
                    _studentCard(filteredStudents[index]),
              ),
            ),
          ),
        ],
  ...
  Widget _studentCard(StudentData s) {
