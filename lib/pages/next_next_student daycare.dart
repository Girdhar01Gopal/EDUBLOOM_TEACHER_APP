// ============================================================
// FILE PATH: lib/pages/next_next_student daycare.dart
// ============================================================
...
import 'father_image daycare.dart';
...
class NextNextStudentdaycare extends GetView<StudentControllerdaycare> {
  const NextNextStudentdaycare({super.key});

  Future<void> _pickImage(BuildContext context) async {
    final source = await showModalBottomSheet<ImageSource>(
      context: context,
      backgroundColor: Colors.transparent,
      builder: (_) => const _ImageSourceSheet(title: 'Student Photo'),
    );
          ...
          children: [
            ...
            _NextButton(
              ...
              onTap: () => Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => FatherImagedaycare()),
              ),
            ),
