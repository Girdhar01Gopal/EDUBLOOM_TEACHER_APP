// ============================================================
// FILE PATH: lib/pages/guardian_image_picker.dart
// ============================================================
...
class GuardianImagePicker extends GetView<StudentController> {
  const GuardianImagePicker({super.key});

  Future<void> _pickImage(BuildContext context) async {
    final source = await showModalBottomSheet<ImageSource>(
      context: context,
      backgroundColor: Colors.transparent,
      builder: (_) => _ImageSourceSheet(title: "Guardian's Photo"),
    );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Guardian's Photo",
            style: TextStyle(
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Last step! Add guardian photo then submit.',
                      style: TextStyle(
                          color: _teal,
                          fontSize: 12.sp,
