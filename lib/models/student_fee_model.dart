class StudentFeeModel {
  ...
  StudentFeeModel({this.listData = const []});
  ...
  factory StudentFeeModel.fromJson(Map<String, dynamic> json) {
    return StudentFeeModel(
      listData: json['listData'] != null
          ? (json['listData'] as List).map((v) => ListData.fromJson(v)).toList()
          : [],
    );
  }

  // Handles APIs that may return either a top-level list or an object.
  factory StudentFeeModel.fromApi(dynamic json) {
    if (json is List) {
      return StudentFeeModel(
        listData: json
            .whereType<Map>()
            .map((v) => ListData.fromJson(Map<String, dynamic>.from(v)))
            .toList(),
      );
    }

    if (json is Map<String, dynamic>) {
      final dynamic rows = json['listData'] ?? json['data'];
      if (rows is List) {
        return StudentFeeModel(
          listData: rows
              .whereType<Map>()
      ...
      return StudentFeeModel.fromJson(json);
    }
  ...
  factory ListData.fromJson(Map<String, dynamic> json) {
    return ListData(
      ...
      dueAmount: json['dueAmount'] != null
          ? int.tryParse(json['dueAmount'].toString())
          : 0,
      payAmount: json['payAmount'] != null
          ? int.tryParse(json['payAmount'].toString())
          : 0,
      totalPay: json['totalPay'] != null
          ? int.tryParse(json['totalPay'].toString())
          : 0,
      ...
      january: json['january'] != null
          ? int.tryParse(json['january'].toString())
          : null,
      february: json['february'] != null
          ? int.tryParse(json['february'].toString())
          : null,
      march:
          json['march'] != null ? int.tryParse(json['march'].toString()) : null,
      april:
          json['april'] != null ? int.tryParse(json['april'].toString()) : null,
      ...
      august: json['august'] != null
          ? int.tryParse(json['august'].toString())
          : null,
      september: json['september'] != null
          ? int.tryParse(json['september'].toString())
          : null,
      october: json['october'] != null
          ? int.tryParse(json['october'].toString())
          : null,
      november: json['november'] != null
          ? int.tryParse(json['november'].toString())
          : null,
      december: json['december'] != null
          ? int.tryParse(json['december'].toString())
          : null,
    );
  }
