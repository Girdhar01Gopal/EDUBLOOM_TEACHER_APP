class viewdaycareattendance {
  List<vListData>? listData;

  viewdaycareattendance({this.listData});

  viewdaycareattendance.fromJson(Map<String, dynamic> json) {
    if (json['listData'] != null) {
      listData = <vListData>[];
      json['listData'].forEach((v) {
        listData!.add(new vListData.fromJson(v));
      });
    }
  }
...
class vListData {
  ...
  vListData.fromJson(Map<String, dynamic> json) {
