// Model for: GET /api/EnquiryApp/SearchEnquiry/{fromDate}/{toDate}/{session}

class SearchEnquiryModel {
  final int? id;
  ...
  /// Blue status baad me POST api ke response ke hisaab se add karenge
  bool get isReplied => reply != null && reply!.trim().isNotEmpty;

  factory SearchEnquiryModel.fromJson(Map<String, dynamic> json) {
    return SearchEnquiryModel(
      id: json['id'] as int?,
  ...
  static DateTime? _parseDate(dynamic value) {
    ...
    if (str.startsWith('0001-01-01')) return null; // .NET default empty date
    return DateTime.tryParse(str);
  }
}

/// List parse karne ke liye helper
List<SearchEnquiryModel> searchEnquiryModelFromJson(List<dynamic> list) {
  return list
      .map((e) => SearchEnquiryModel.fromJson(e as Map<String, dynamic>))
      .toList();
}